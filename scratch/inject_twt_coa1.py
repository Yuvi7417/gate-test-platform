...
twt_coa1_js = generate_js(q, "TWT - Computer Organization and Architecture-1", "August 30, 2026")

with open('h:/yuvraj dutt/js/test-registry.src.js', 'a', encoding='utf-8') as f:
    f.write('\n\n' + twt_coa1_js)

print("Injected TWT - Computer Organization and Architecture-1 successfully!")
