...
c3_js = generate_js(q3, "SWT - C-Programing-3", "August 23, 2026") # Assuming next week date or just August 23
...
print("Injected SWT - C-Programing-3 successfully!")
