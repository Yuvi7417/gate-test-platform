...
`,
    ...
    },
    {
      ...
      neg: 0.66,
      type: "MCQ",
      text: "Consider the following statement A 4 : 16 decoder can be constructed (with enable input) by;________.<br><br>Which of the statements given below is/are correct?",
      image: "",
      options: [
    ...
    },
    {
      ...
      neg: 0,
      type: "NAT",
      text: "Consider the function:<br><br><img src='images/digital logic-1/mceclip47-1777717683574.png' alt='Option A' style='max-width:150px;'> <br><br>where 'f' represents Boolean function and 'd' represents don’t care condition. The simplified Boolean expression 'f' is reduced to ________ literals.",
      image: "",
      options: [],
      answer: 4,
