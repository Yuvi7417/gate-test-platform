  ...
  questions: [
    {
      ...
      image: "",
      options: [
        "<img src='images/database-1/17.png' alt='Option A' style='max-width:150px;'>",
        "<img src='images/database-1/18.png' alt='Option B' style='max-width:150px;'>",
        "<img src='images/database-1/16.png' alt='Option C' style='max-width:150px;'>",
        "<img src='images/database-1/15.png' alt='Option D' style='max-width:150px;'>",
      ],
      answer: "B",
