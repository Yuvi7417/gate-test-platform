  ...
  questions: [
    {
      ...
      neg: 0.33,
      type: "MCQ",
      text: "Consider the following statements about the relational data model:<br><br>S<sub>1</sub> : A foreign key attribute can take NULL values even when it participates in a composite foreign key.<br><br>S<sub>2</sub> : If a foreign key in a relation R references a candidate key of another relation, then every non-NULL value of the foreign key must match some tuple in the referenced relation.",
      image: "",
      options: [
        "<img src='images/js/questions/database-1/17.png' alt='Option A' style='max-width:150px;'>",
        "<img src='images/js/questions/database-1/18.png' alt='Option B' style='max-width:150px;'>",
        "<img src='images/js/questions/database-1/16.png' alt='Option C' style='max-width:150px;'>",
        "<img src='images/js/questions/database-1/15.png' alt='Option D' style='max-width:150px;'>",
      ],
      answer: "B",
