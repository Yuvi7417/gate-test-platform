...
`,
    ...
    },
    {
      ...
      neg: 0,
      type: "NAT",
      text: "Consider a B-tree in the given figure, where each node has atleast 2 and atmost 4 keys.<br>Keys 6 and 21 are inserted into this tree in that order. The number of nodes (disregarding the links) present with exactly same structure given below in the tree after the two insertions is _______.",
      image: "<img src='js/questions/database-1/2.png' alt='Detailed Solution'><br><img src='js/questions/database-1/3.png' alt='Detailed Solution'>",
      options: [],
      answer: 4,
