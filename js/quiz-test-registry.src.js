  ...
  questions: [
    {
      ...
      neg: 0,
      type: "MSQ",
      text: `<p></p> <p>Consider the following simple Finite Automaton.</p> <p style="text-align:center"><img alt="" src="/images/quiz/wqt-toc3/q1_img1.png" style="max-width: 75%;"></p> <p>Which of the following strings are not accepted by the given finite automaton?</p> <p></p>`,
      image: "",
      options: [
        `\\( 010110 \\)`,
        `\\( 101000 \\)`,
    ...
    },
    {
      ...
      neg: 0,
      type: "NAT",
      text: `<p></p> <p>How many of these are DFAs over  \\( \\{0, 1\\}? \\) </p> <p style="text-align:center"><img alt="" src="/images/quiz/wqt-toc3/q3_img2.png" style="max-width: 75%;"></p> <p>&nbsp;</p> <p></p>`,
      image: "",
      options: [],
      answer: "3",
    ...
    },
    {
      ...
      neg: 0,
      type: "NAT",
      text: `<p></p> <p>We transform the following NFA into an equivalent DFA using the subset construction (or the powerset construction) algorithm.</p> <p style="text-align:center"><img alt="" src="/images/quiz/wqt-toc3/q5_img4.png" style="max-width: 75%;"></p> <p>How many of these rows should be marked as accepting states?</p> <p></p>`,
      image: "",
      options: [],
      answer: "6",
    ...
    },
    {
      ...
      neg: 0.67,
      type: "MCQ",
      text: `<p></p> <p>We transform the following NFA into an equivalent DFA using the subset construction (or the powerset construction) algorithm.</p> <p style="text-align:center"><img alt="" src="/images/quiz/wqt-toc3/q8_img7.png" style="max-width: 75%;"></p> <p style="text-align:center"><img alt="" src="/images/quiz/wqt-toc3/q8_img8.png" style="max-width: 75%;"></p> <p>What should this row look like?</p> <p></p>`,
      image: "",
      options: [
