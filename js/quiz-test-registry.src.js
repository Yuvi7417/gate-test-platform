  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        `\( (b+d)left(a+c+d^{prime} ight)(a+b+c)=(b+d)left(a+c+d^{prime} ight) \)`,
        `A Only`,
        `B Only`,
        `Both`,
        `None`,
    ...
    },
    {
      ...
      image: "",
      options: [
        `\( displaystyle{} fleft(w_{1}, w_{2}, w_{3} ight)=sum_{m}(0,1,3,4,6,7) \)`,
        `\( displaystyle{} fleft(w_{1}, w_{2}, w_{3} ight)=sum_{m}(1,2,4,5,7,8) \)`,
        `\( displaystyle{} fleft(w_{1}, w_{2}, w_{3} ight)=prod_{M}(0,1,3,4,6,7) \)`,
        `\( displaystyle{} fleft(w_{1}, w_{2}, w_{3} ight)=sum_{m}(2,5) \)`,
      ],
      answer: ["A"],
